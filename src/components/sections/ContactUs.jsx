...
const ContactUs = () => {
  ...
  return (
    <section className="mx-auto w-full max-w-360 overflow-hidden bg-dark-secondary">
      <div className="flex flex-col lg:flex-row">
        ...
        >
          <div className="mx-auto max-w-105.25 px-4 sm:px-5">
            ...
            >
              ...
              <a
                href="tel:+12193656931"
                className="jost text-[15px] sm:text-base font-normal leading-150 text-white transition hover:text-gray-300"
              >
                (219) 365-6931
              </a>
            </div>
            ...
            >
              ...
              <a
                href="mailto:scott.eggert@att.net"
                className="jost break-all text-[15px] sm:text-base font-normal leading-150 text-white transition hover:text-gray-300"
              >
            ...
            >
              ...
              <p className="max-w-[250px] jost text-[15px] sm:text-base font-normal leading-150 text-white">
        ...
        <div
          data-aos="fade-left"
          data-aos-delay="300"
          className="relative min-h-[350px] sm:min-h-[500px] lg:min-h-180.25 h-full w-full max-w-full lg:max-w-221.25"
        >
          <iframe
