...
const OurService = () => {
  ...
  return (
    <section className="w-full py-20 sm:py-28 lg:py-37.5 px-4 sm:px-6 min-[1330px]:px-0">
      ...
      <div className="mx-auto max-w-328 w-full">
        ...
        <div className="flex flex-col justify-between gap-8 sm:gap-10 md:flex-row md:items-end">
          ...
          {/* RIGHT BUTTON */}
          <button className="underline cursor-pointer underline-offset-[25%] text-[11px] sm:text-[12px] tracking-20 font-medium jost leading-150 text-dark-primary transition-all duration-300 hover:opacity-70">
        ...
        <div className="mt-10 sm:mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          {services.map((item, index) => (
            <div
              ...
              className="border cursor-pointer border-gray-light p-6 sm:p-8 hover:bg-offwhite"
            >
              ...
              {/* BUTTON */}
              {item.button && (
                <button className="mt-8 underline underline-offset-[25%] jost font-medium text-[11px] sm:text-[12px] leading-150 tracking-20 text-dark-primary">
                  {item.button}
                </button>
              )}
            </div>
